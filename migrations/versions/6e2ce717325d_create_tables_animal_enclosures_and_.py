"""Create tables Animal,enclosures and zookeepers

Revision ID: 6e2ce717325d
Revises: 
Create Date: 2023-09-24 02:21:38.938277
...
def upgrade():
    ...
    sa.Column('open_to_visitors', sa.Boolean(), nullable=False),
